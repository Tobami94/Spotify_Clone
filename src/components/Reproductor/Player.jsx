...
const CurrentMusicActual = ({ image, title, artists }) => {
  //muestra el artista e imagen del album en el reproduc.
  return (
...
const VolumeControl = () => {
  ...
  const renderVolumeIcon = () => {
    //swich define los casos donde renderizara los icons.  Vídeo.
    switch (true) {
