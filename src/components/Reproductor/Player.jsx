...
export const Volume = () => (
  ...
  export const MidVolume = () => (
    <svg fill="currentColor"  role="presentation" height="16" width="16"  aria-label="Volumen medio" aria-hidden="true" id="volume-icon" viewBox="0 0 16 16"><path d="M9.741.85a.75.75 0 0 1 .375.65v13a.75.75 0 0 1-1.125.65l-6.925-4a3.642 3.642 0 0 1-1.33-4.967 3.639 3.639 0 0 1 1.33-1.332l6.925-4a.75.75 0 0 1 .75 0zm-6.924 5.3a2.139 2.139 0 0 0 0 3.7l5.8 3.35V2.8l-5.8 3.35zm8.683 6.087a4.502 4.502 0 0 0 0-8.474v1.65a2.999 2.999 0 0 1 0 5.175v1.649z"></path></svg>
  )


const CurrentMusicActual = ({ image, title, artists }) => { //muestra el artista e imagen del album en el reproduc. 
  return(
...
const VolumeControl = () => {
  ...
  const previousVolumeRef = useRef(volume) //guardamos el anterior vol al tocar el icon

  const isVolumeSilenced = volume < 0.1;
  const isVolumeMin = volume >= 0.1 && volume < 0.4;
  const isVolumeMid = volume >= 0.4 && volume < 0.7;
  ...
  const renderVolumeIcon = () => { //swich define los casos donde renderizara los icons. 
    switch (true) {
      case isVolumeSilenced:
